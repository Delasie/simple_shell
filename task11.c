 ...
 * @num: this is the node index that is used by history
 *
 * Return: size of list
 */
 ...
 * @head: this is the address of pointer to head node
 * @str: this is the str field of node
 * @num: represents the node index that is used by history
 *
 * Return: size of list
 */
...
/**
 * print_list_str - this function prints only the str element of the  list_t list that has been linked
 ...
 * @index: represents the index of node that has to be delete
 *
