...
/**
 * input_buf - Buffer for chained commands.
...
ssize_t input_buf(info_t *info, char **buf, size_t *len)
{
    ...
    if (!*len) {
        // If nothing is left in the buffer, fill it.
        // bfree((void **)info->cmd_buf); // Unused code
        free(*buf);
        *buf = NULL;
 ...
 * @info: Parameter structure.
 * @ptr: Address of the pointer to a buffer, preallocated or NULL.
